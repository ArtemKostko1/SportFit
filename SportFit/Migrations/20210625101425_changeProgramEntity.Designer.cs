...
namespace SportFit.Migrations
{
    ...
    [Migration("20210625101425_changeProgramEntity")]
    partial class changeProgramEntity
    {
            ...
            modelBuilder.Entity("SportFit.Data.Entities.ComplexityLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6b2db819-004b-434a-b356-5c5772c3b9b3"),
                            Name = "Легко"
                        },
                        new
                        {
                            Id = new Guid("fdc5cfe9-d44c-4b37-acb3-c324f0bc3c5b"),
                            Name = "Средне"
                        },
                        new
                        {
                            Id = new Guid("c3ed170d-ba4b-4081-a795-24b75aab78e2"),
                            Name = "Сложно"
                        },
                        new
                        {
                            Id = new Guid("e35608e5-9f62-4ab2-9546-57518841480c"),
            ...
            modelBuilder.Entity("SportFit.Data.Entities.ProgramType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6bee3b9a-fe39-4bd1-984f-90cab9e69b71"),
                            Name = "Программа тренировки"
                        },
                        new
                        {
                            Id = new Guid("6ae7c82c-cf2d-47f0-8492-67e8cd46ee5b"),
                            Name = "План питания"
                        });
                });
