        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Programs_ComplexityLevels_ComplexityLevelId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tags_Programs_ProgramId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SelectedPrograms", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProgramTags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProgramTags_Programs_ProgramId",
                        column: x => x.ProgramId,
                        principalTable: "Programs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProgramTags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Programs_ComplexityLevelId",
                table: "Programs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProgramTags_ProgramId",
                table: "ProgramTags",
                column: "ProgramId");

            migrationBuilder.CreateIndex(
                name: "IX_ProgramTags_TagId",
                table: "ProgramTags",
                column: "TagId");

            migrationBuilder.CreateIndex(
                name: "IX_SelectedPrograms_ProgramId",
                table: "SelectedPrograms",
                column: "ProgramId");

            migrationBuilder.CreateIndex(
                name: "IX_SelectedPrograms_UserId",
                table: "SelectedPrograms",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Tags_ProgramId",
                table: "Tags",
                column: "ProgramId");
